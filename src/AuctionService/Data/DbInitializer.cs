...
public class DbInitializer
{
    public static void InitDb(WebApplication app)
    {
        ...
        var _context = scope.ServiceProvider.GetService<AuctionDbContext>();
        var _url = app.Configuration.GetConnectionString("DefaultConnection") ?? "Server=localhost:5432;User Id=postgres;Password=postgrespw;Database=auctions";
        SeedData(_context!, _url);
    }

    private static async void SeedData(AuctionDbContext auctionDbContext, string url)
    {
        // System.Console.WriteLine("HOST IS NULL YANONG!!");
        // System.Console.WriteLine(auctionDbContext.Database.GetConnectionString());

        auctionDbContext.Database.SetConnectionString(url);
